...
$dest = "../ProjektDino_/speicherstände/workshop22";
...
$directory = realpath("../ProjektDino_/speicherstände/workshop22");
$options = array("remove_path" => $directory);
$zip->addPattern("/\.(?:json)$/", $directory, $options);
$zip->close();
}
//löscht alle existenten Export-Jsons 
array_map("unlink", glob("../ProjektDino_/speicherstände/workshop22/*.json"));
}

//Bilder-Teil Export
if($_POST['Bilder'] == "1"){
try{
            $images_directory="../ProjektDino_/images";
...
if($_POST['Dateien'] == "1"){
try{
            $files_directory="../ProjektDino_/files";
