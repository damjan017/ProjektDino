...
<?php if (!empty($Zimmertyp_list)): ?>
    ...
    <h3>
        <?=count($Zimmertyp_list)?> Ergebnis(se) gefunden
    </h3>
    ...
    <?php foreach ($Zimmertyp_list as $zimmer): ?>
        ...
        <?php
        /*
         * Bild für das Suchergebnis bestimmen.
         */
        ...
        <div class="ui-body ui-body-a"
            ...
            <div style="display:flex;
                ...
                <img src="images/<?=htmlspecialchars($ergebnisBild)?>"
                     alt="Unterkunft"
                     style="width:120px;
                            height:90px;
                            object-fit:cover;
                ...
                <div style="flex:1; min-width:200px;">
                    ...
                    <h4 style="margin:0 0 4px;">
                        <?=htmlspecialchars($zimmer->Unterkunft_Name)?>
                    </h4>
                    ...
                    <p style="margin:4px 0;">
                        ...
                        <strong>
                            <?=htmlspecialchars($zimmer->Bezeichnung_literal)?>
                        </strong>

                        &middot;

                        <?=(int)$zimmer->Anzahltbett?> Bett(en)

                        &middot;

                        <?=htmlspecialchars($zimmer->ArtBett)?>
...
<?php elseif (isset($_POST["suchen"])): ?>
    ...
    <div class="ui-body ui-body-a"
        ...
        <p>
            Keine verfügbaren Zimmer für Ihre Suche gefunden.
        </p>
