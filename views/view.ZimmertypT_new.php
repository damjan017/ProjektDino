...
?>
<a href="?task=ZimmertypT" class="ui-btn ui-icon-back ui-btn-icon-notext ui-corner-all" align="right">No text</a>
<form id="form_ZimmertypT" method="post" action="?task=ZimmertypT_new" data-ajax="false" enctype="<?=$ZimmertypT::$enctype?>">
