...
<p><h3>Beziehungsübersicht zur Klasse: Kunde <a href="#popup_Kunde" data-rel="popup" data-transition="pop" class="my-tooltip-btn ui-btn ui-alt-icon ui-nodisc-icon ui-btn-inline ui-icon-info ui-btn-icon-notext" title="Erfahre mehr">Erfahre mehr</a></h3></p>
<div data-role="popup" id="popup_Kunde" class="ui-content" data-theme="a" style="max-width:800px;">
<h3>Informationen zu dieser Beziehung ():</h3><br>
Buchung (*..*) ---- (1..1) Kunde <br><br>
<h4>Bedeutet für diese Seite der Beziehung:</h4>
<p>Das Objekt in dieser Detailansicht (aus der Klasse: Buchung) muss genau eine Verbindung zu einem Objekt der Partnerklasse (Kunde) haben (1..1).</p><br>
...
$klasse->renderLabel("Personalausweisnrummer", "detail");
$klasse->render("Personalausweisnrummer", "detail");
